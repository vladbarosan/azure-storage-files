...
// ContentMD5 returns the value for header Content-MD5.
func (furr FileUploadRangeResponse) ContentMD5() string {
	return furr.rawResponse.Header.Get("Content-MD5")
}
...
// Response returns the raw HTTP response object.
func (sp ServiceProperties) Response() *http.Response {
	return sp.rawResponse
}

// StatusCode returns the HTTP status code of the response, e.g. 200.
func (sp ServiceProperties) StatusCode() int {
	return sp.rawResponse.StatusCode
}

// Status returns the HTTP status message of the response, e.g. "200 OK".
func (sp ServiceProperties) Status() string {
	return sp.rawResponse.Status
}

// RequestID returns the value for header x-ms-request-id.
func (sp ServiceProperties) RequestID() string {
	return sp.rawResponse.Header.Get("x-ms-request-id")
}

// Version returns the value for header x-ms-version.
func (sp ServiceProperties) Version() string {
